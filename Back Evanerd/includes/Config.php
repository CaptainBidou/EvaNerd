...
class Config {
    ...
    private static $BDD_user="tomas"; // Nom de l'utilisateur de la base de donnée
    private static $BDD_password="azerty"; // Mot de passe du compte utilisateur
    private static $BDD_base="evanerds"; // nom de la base de donnée 
