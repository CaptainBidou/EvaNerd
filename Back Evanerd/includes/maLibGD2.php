...
function defaultPicture($output, $firstName, $lastName, $font= "arial.ttf") {
    ...
    imagettftext($image, $fontSize, 0, (450/2 - intval($textWidth/2)) + intval($textWidth*0.05), intval(450/2) + intval($textHeight/2), $borderColor, $font, $initials);
    imagettftext($image, $fontSize, 0, 450/2 - intval($textWidth/2), 450/2 + intval($textHeight/2), $textColor, $font, $initials);
