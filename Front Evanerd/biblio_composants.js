...
var JPostLike= $("<img>").addClass("icon").data("type","post_like").attr('src','Ressources/Accueil/like.png').on("click",function(context){JClickLike(context.target); var nblike=parseInt($(".Post-Nb-Likes", this.parentElement).text()); $(".Post-Nb-Likes", this.parentElement).text(nblike+1)});
